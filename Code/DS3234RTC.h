//Definitions and declarations used for communications and control with DS3234 RTC device
...
void init_RTC(void);									//Initialise the RTC (actually initialise the AVR to use SPI comms with the RTC).
...
void RTC_getTime (uint8_t *time);						//Fill in all array fields from data in the RTC.  All bytes are BCD representations of data..
