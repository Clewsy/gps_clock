...
//Reads and returns a byte at the desired address.
uint8_t RTC_SPI_readByte(uint8_t address)
{
...
void RTC_SPI_writeByte(uint8_t address, uint8_t data)
{
	SLAVE_SELECT_RTC;			//Enable the RTC comms
