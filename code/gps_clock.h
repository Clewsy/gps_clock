...
#define MODE_3_EPOCH	0b100	//	|E P O C H   S S S S S S S S S S |	Epoch time (seconds elapsed since midnight, Jan 1st, 1970).  Aka UNIX time.
#define MODE_4_OFFSET	0b101	//	|A d J U S t             ± # #.# |	Enable setting of the time offset from UTC.
...
static uint8_t splash[16] = {	SEV_SEG_MANUAL_C, SEV_SEG_MANUAL_L, SEV_SEG_MANUAL_O, SEV_SEG_MANUAL_C, SEV_SEG_MANUAL_Y, SEV_SEG_MANUAL_DASH,
...
static uint8_t offset_txt[8] = {SEV_SEG_MANUAL_O, SEV_SEG_MANUAL_F, SEV_SEG_MANUAL_F, SEV_SEG_MANUAL_S, SEV_SEG_MANUAL_E, SEV_SEG_MANUAL_T, 0, 0};//"OFFSEt  "
